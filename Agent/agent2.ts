...
const RESPONSE_MODE = "sync"; // Now dynamic
const AGENT_IDS = ["agent-1712327325","agent-1713962163","agent-1768559587","agent-1768562436"]; // Dynamic array from PluginIds
const ENDPOINT_ID = "predefined-xai-grok4.1-fast";
const REASONING_MODE = "grok-4-fast";
const FULFILLMENT_PROMPT = "You receive normalized audio frames and extract speech features.

Compute and return numerical metrics such as:
- pitch
- volume
- speaking pace
- stress index
...
Return only structured JSON with numeric values.
";
